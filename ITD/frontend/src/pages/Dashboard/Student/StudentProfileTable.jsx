            ...
            <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
                <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div className="overflow-x-auto">
                        {/* Table 1 */}
                        <table className="w-full text-center text-sm text-left text-gray-500 dark:text-gray-400 table-fixed">
                            <thead>
                                <tr>
                        ...
                        <table className="w-full text-center text-sm text-left text-gray-500 dark:text-gray-400 table-fixed">
                            <tbody>
                                <tr className="border-b dark:border-gray-700">
                                    <th className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white w-25">Skills</th>
                                    <td className="px-4 py-3 w-75 justify-center">{user.skills}</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table className="w-full text-center text-sm text-left text-gray-500 dark:text-gray-400 table-fixed">
                            <tbody>
                                <tr className="border-b dark:border-gray-700">
                                    <th className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white w-25 align-middle">Languages Spoken</th>
                                    <td className="px-4 py-3 w-75">{user.languageSpoken}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
