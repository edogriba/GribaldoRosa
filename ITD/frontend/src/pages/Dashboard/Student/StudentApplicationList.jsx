                        ...
                        return (
                            <tr key={application.application.applicationId} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                    <img className="w-10 h-10 rounded-full" src={application.company.company_photoPath ? `/uploads/${application.company.company_id}/${application.company.company_photoPath}` : `/user.jpg`} alt="Profile"/>
                                    <div className="ps-3">
