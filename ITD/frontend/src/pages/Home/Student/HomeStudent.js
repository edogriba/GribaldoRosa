            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div class="max-w-screen-md mb-8 lg:mb-16">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Welcome to the Student Home Page</h2>
                        <p class="text-gray-500 sm:text-xl dark:text-gray-400">Ready to land your the internship of your dreams?</p>
                    </div>
                    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <Link to="/students/update">
                            <div>
                                ...
                                <h3 class="mb-2 text-xl font-bold dark:text-white">Your Information</h3>
                                <p class="text-gray-500 dark:text-gray-400">Update your profile and upload your resume.</p>
                            </div>
                        </Link>
                        <Link to="/students/search">
                            <div>
                                ...
                                <h3 class="mb-2 text-xl font-bold dark:text-white">Search for Internships</h3>
                                <p class="text-gray-500 dark:text-gray-400">Find and apply for internships that match your skills and interests.</p>
                            </div>
                        </Link>
                        <Link to="/students/dashboard/profile">
                            <div>
                                ...
                                <h3 class="mb-2 text-xl font-bold dark:text-white">Applications and Internships</h3>
                                <p class="text-gray-500 dark:text-gray-400">Check the status of your applications and track your internship progress.</p>
                            </div>
                        </Link>
                    </div>
                </div>
