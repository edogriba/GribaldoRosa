            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        ...
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Ready to recruit the human resources of your dreams?</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        ...
                        <Link to="/companies/create-position">
                            <div>
                                ...
                                <h3 className="mb-2 text-xl font-bold dark:text-white">Offer a new internship position</h3>
                                <p className="text-gray-500 dark:text-gray-400">Create an offer for an internship position</p>
                            </div>
                        </Link>
