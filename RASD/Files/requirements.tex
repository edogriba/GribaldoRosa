...
\subsection{Functional Requirements}
    ...
    \subsubsection*{Users:}
        \begin{enumerate}[label=\textbf{R\arabic*}]
            \item S\&C shall allow users to sign up.                    % US DONE
            \item S\&C shall allow users to confirm their mail          % US DONE
            \item S\&C shall allow users to log in.                     % US DONE
            \item S\&C shall allow users to log out.                    % US DONE
            % US DONE
            \item S\&C shall allow users to update their profile information.       % US DONE
    ...
    \subsubsection*{Students:}
        \begin{enumerate}[label=\textbf{R\arabic*},resume]
            ...
            \item After they registered and confirmed their email, S\&C shall allow students to upload their CV.   % US DONE
            ...
            \item S\&C shall allow students to search for a specific kind of internship.    % US DONE 
            \item S\&C shall allow students to apply for an internship.                     % US DONE
            \item If an internship position suited to a student is opened, S\&C shall notify the student
            \item When a student issues a search for an internship, S\&C shall list the different positions aligned with the student's profile.         % US DONE
